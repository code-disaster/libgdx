...
/** <p>
 * Emulates VertexBufferObjectWithVAO by simply extending {@link VertexBufferObject}
 * </p> */
public class VertexBufferObjectWithVAO extends VertexBufferObject {
	...
	public VertexBufferObjectWithVAO (boolean isStatic, int numVertices, VertexAttributes attributes) {
		super(isStatic, numVertices, attributes);
	}
}
